...
namespace Swoopo.Utils
{
	...
	public class We7Request
	{
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !We7Utils.IsSafeSqlString(HttpContext.Current.Request.QueryString[strName]))
            {
        ...
        public static string GetFormString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !We7Utils.IsSafeSqlString(HttpContext.Current.Request.Form[strName]))
            {
                return "unsafe string";
            }
		...
		{
			return We7Utils.StrToInt(HttpContext.Current.Request.QueryString[strName], defValue);
		}
		...
		{
			return We7Utils.StrToInt(HttpContext.Current.Request.Form[strName], defValue);
		}
		...
		{
			return We7Utils.StrToFloat(HttpContext.Current.Request.QueryString[strName], defValue);
		}
		...
		{
			return We7Utils.StrToFloat(HttpContext.Current.Request.Form[strName], defValue);
		}
		...
		public static string GetIP()
		{
			...
			if (string.IsNullOrEmpty(result) || !We7Utils.IsIP(result))
			{
				return "127.0.0.1";
			}
...
//				if(We7Utils.InArray(fileextname, AllowFileExtName) && (filesize <= MaxAllowFileSize * 1024) && We7Utils.InArray(filetype, AllowFileType))
//				{
//
//					HttpContext.Current.Request.Files[i].SaveAs(Dir + We7Utils.GetDateTime() + Environment.TickCount.ToString() + fileextname);
